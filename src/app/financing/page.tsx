...
export const metadata: Metadata = {
  title: "Financing for Painting and Remodeling Projects",
  description: clampDescription(`Finance your painting or remodeling project in Baltimore with flexible payment plans through HFS Financial. Inquire in minutes with no impact to your credit score. Personal loans up to $300,000, fixed rates as low as 7.8%, terms up to 20 years. Licensed contractor ${SITE.license}.`),
  keywords: [
