...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      url: `${SITE.url}/api/og?title=Contact+Us&subtitle=Get+a+Free+Estimate+in+Baltimore%2C+MD`,
    ...
    <>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 min-h-[420px] md:min-h-[480px]">
            ...
            <div className="relative z-10 flex flex-col justify-center px-6 sm:px-10 lg:px-16 py-16 md:py-20">
              <span className="inline-flex items-center gap-2 text-brand-green text-sm font-semibold tracking-wide uppercase mb-4">
      ...
      <Section id="estimate-form">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Fill out the form and we will reach out to schedule a time that
        ...
        <div className="grid gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg shadow-black/[0.04] border border-border/40">
              ...
              <ul className="space-y-5">
                <li>
                  <a
                    href={SITE.phoneTel}
                    className="flex items-center gap-4 text-foreground hover:text-brand-green transition-colors group"
                  >
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-brand-green/15 to-brand-green/5 group-hover:from-brand-green/25 transition-colors">
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">Baltimore and Surrounding Counties</p>
                  </div>
                </li>
                <li className="flex items-center gap-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-brand/15 to-brand/5">
            ...
            {/* Calendly booking — only when NEXT_PUBLIC_CALENDLY_URL is set */}
            {hasCalendly() && env.calendlyUrl && (
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg shadow-black/[0.04] border border-border/40">
                <h3 className="font-bold text-lg mb-2">Prefer to Book Directly?</h3>
                <p className="text-sm text-muted-foreground mb-5">
                  Schedule a time that works for you and we will come out for
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 w-full justify-center bg-gradient-to-br from-brand-green to-brand-green-dark text-white px-5 py-3.5 rounded-lg font-semibold text-sm hover:shadow-lg hover:shadow-brand/25 transition-all duration-300"
                >
            ...
            <div className="relative overflow-hidden bg-primary text-primary-foreground rounded-2xl p-6 md:p-8">
              <div className="absolute top-0 right-0 h-24 w-24 bg-brand-green/10 rounded-full -translate-y-1/2 translate-x-1/2" />
              <div className="absolute bottom-0 left-0 h-16 w-16 bg-brand-green/10 rounded-full translate-y-1/2 -translate-x-1/2" />
              <div className="relative">
                <h3 className="font-bold text-lg mb-2">Licensed and Insured</h3>
                <p className="text-primary-foreground/70 text-sm leading-relaxed">
                  {SITE.license} &mdash; fully licensed with the Maryland Home
      ...
      <Section variant="dark-gradient">
        <div className="text-center mb-10">
          ...
          <p className="text-primary-foreground/70 max-w-xl mx-auto">
            Browse real projects we have completed for homeowners throughout
            the Baltimore area.
          </p>
        </div>
      ...
      <Section variant="warm">
        ...
        <div className="rounded-2xl overflow-hidden shadow-xl shadow-black/[0.08] max-w-4xl mx-auto border border-border/40">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d99252.34!2d-76.6413!3d39.2904!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c803aed6f483b7%3A0x44896a84223e758!2sBaltimore%2C%20MD!5e0!3m2!1sen!2sus!4v1"
            width="100%"
            height="300"
            ...
            title="Elite Finishes service area - Baltimore, Maryland and surrounding counties"
          />
        </div>
        <p className="text-center text-muted-foreground mt-6 text-sm">
          Proudly serving Baltimore City, Baltimore County, Anne Arundel County, Howard County,
          and surrounding communities throughout Maryland.
        </p>
      </Section>
    </>
  );
